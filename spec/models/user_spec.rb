...
describe User do  
  ...
  it "should create a new instance given a valid attibute set" do
  User.create!(@attr)
  end
  ...
  it "should accept valid email addresses" do
    addresses = %w[user@foo.com THE_USER@foo.com.org first.last@example.org]
  ...
  describe  "authenticate" do
    ...
    it "should return nil for an email address which does not exist" do
      User.authenticate("bar@foo.com", @attr[:password]).should be_nil
    end
    
    it "should return nil for an email address which does not exist" do
       User.authenticate(@attr[:email], @attr[:password]).should be_nil
     end
  end
end
